...
!function (a) {
  ...
  function b(a, c) {
    ...
    if (c !== b._globalHandlerInstalled) {
      ...
      }, afterClose: function afterClose(b, c) {
        var d = b(c),
...
$('.gallery-filter-trigger').on('click', function (event) {
...
var filterGallery = function filterGallery(something) {
...
$('.js-primary-navigation-toggle').on('click', function () {
